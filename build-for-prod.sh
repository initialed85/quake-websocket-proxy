...
sed -i.bak s%ws://localhost:8081/ws%wss://quake.initialed85.cc/ws%g ../Quake-WASM/WinQuake/net_websocket.c
sed -i.bak s%ws://localhost:8081/ws%wss://quake.initialed85.cc/ws%g ../Quake-WASM/WinQuake/Makefile.emscripten
